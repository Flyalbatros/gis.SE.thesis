    ...
    def output_line(self):
        ...
        for line in all_lines:
            if line[3:6] == "row":
                ...
                str_dict['Id'] = 'None'
                str_dict['PostId'] = '-99'
                str_dict['VoteTypeId'] = '-99'
                str_dict['UserId'] = '-99'
                str_dict['CreationDate'] = '0001-01-01 00:00:00'
                str_dict['BountyAmount'] = 'None'
...
if __name__=="__main__":
    ...
    #print(file.readline())
    user_file = xml_reader("Votes.xml")
    command_strs = user_file.output_line()
    for data_dict in command_strs:
        #print(data_dict)
        data_string = "'{0}','{1}','{2}','{3}','{4}'".format(
             data_dict['Id'], data_dict['PostId'], data_dict['VoteTypeId'], data_dict['UserId'], data_dict['CreationDate'])
        target_db.query_and_return("Insert into votes_GIS values ("+data_string+")")
    target_db.save()
